...
export default function parse(element, { document }) {
  ...
  if (eyebrow) {
    eyebrowContainer.append(document.createComment(' field:eyebrow '));
  ...
  if (ctaLinks.length > 0) {
    primaryLinkContainer.append(document.createComment(' field:primaryLink '));
    primaryLinkContainer.append(ctaLinks[0].cloneNode(true));
  }
  ...
  if (ctaLinks.length > 1) {
    secondaryLinkContainer.append(document.createComment(' field:secondaryLink '));
    secondaryLinkContainer.append(ctaLinks[1].cloneNode(true));
  }
